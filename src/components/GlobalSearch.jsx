...
const KNOWN_HUBS = [
  ...
  { key: 'qualytree.complaints',           path: '/complaint',                        label: '고객불만',    tf: ['title','productName','complaintNo','customerName'] },
  { key: 'qualytree.import_adverse',       path: '/import-gmp/adverse',               label: '이상사례',    tf: ['productName','title','reportNo','description'] },
  ...
  { key: 'qualytree.foreignManufacturers', path: '/import-gmp/foreign-manufacturers', label: '외국제조소',  tf: ['name','company','country','businessNo'] },
  { key: 'qualytree.risks',                path: '/risk',                             label: '위험관리',    tf: ['hazard','title','riskId','sequence'] },
  { key: 'qualytree.changes',              path: '/change',                           label: '변경관리',    tf: ['title','changeNo','subject','area'] },
  ...
  { key: 'qualytree.documents',            path: '/doc-control',                      label: '문서',        tf: ['title','docNo','name','revision'] },
  { key: 'qualytree.employees',            path: '/competency',                       label: '역량',        tf: ['name','department','position','employeeId'] },
  { key: 'qualytree.trainings',            path: '/competency',                       label: '교육',        tf: ['subject','title','trainee','instructor'] },
  ...
  { key: 'qt_records',                path: '/records',                          label: '기록',        tf: ['title','name','type','recordNo'] },
]
