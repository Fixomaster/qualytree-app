...
{ to: '/manufacturing', label: 'ìì° íí©' },
      { to: '/batch-records', label: 'ììì§ìÂ·ë°°ì¹ê¸°ë¡' },
...
{ to: '/service', label: 'ì¤ì¹Â·ìë¹ì¤' },
  { to: '/oem-full', label: 'OEM ì ê³µì ìí' },
  { to: '/oem-partial', label: 'OEM ì¼ë¶ìí' },
],
},
{
...
{ to: '/kpi-dashboard', label: 'íì§ KPI' },
    ...
    { to: '/enterprise-risk', label: 'ì ì¬ ìíê´ë¦¬' },
],
},
{
...
{ to: '/design-history', label: 'ì¤ê³ì´ë ¥íì¼(DHF)' },
          { to: '/risk', label: 'ì í ìíê´ë¦¬ (ISO 14971)' },
          { to: '/device-master-record', label: 'ìë£ê¸°ê¸° íì¼(DMR)' },
      { to: '/product-standard', label: 'ì í íì¤ì' },
      { to: '/label-packaging', label: 'ë¼ë²¨Â·í¬ì¥ì¬ ê´ë¦¬' },
],
},
{
...
{ to: '/document-control', label: 'ë¬¸ìê´ë¦¬' },
      { to: '/sop', label: 'ììíì¤ì(SOP)' },
      { to: '/quality-manual', label: 'íì§ë§¤ë´ì¼' },
],
},
{
...
<span className="flex-1">ë°±ìÂ·DR ê´ë¦¬</span>
</NavLink>
<NavLink
to="/billing"
className="flex items-center gap-3 px-3 py-2 rounded-lg text-[13px] mb-0.5 transition"
...
<span className="flex-1">íë ë° ê²°ì </span>
</NavLink>
<div
