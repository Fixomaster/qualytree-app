...
const SECTIONS = [
  {
    ...
    items: [
      ...
      {
        id: '4.2.4', label: '문서관리 절차 — 검토·승인·식별·배포·최신본 유지',
        detail: '품질경영시스템 요구 문서를 관리하기 위한 절차를 문서화하여야 한다. 발행 전 검토·승인, 최신 개정본 식별, 필요 장소 이용 가능, 읽기 가능성·식별 보장, 외부 문서 식별·배포 통제, 폐기 문서의 오용 방지 조치를 포함하여야 한다.',
        links: [{ label: '문서관리', path: '/doc-control' }]
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: '5.4.1', label: '품질목표 — 조직 각 기능·계층에 측정 가능한 목표 수립',
        detail: '최고 경영자는 조직의 관련 기능 및 계층에서 품질목표가 수립됨을 보장하여야 한다. 품질목표는 측정 가능하고 법적 요구사항을 포함하며 제품 요구사항 충족에 필요한 것을 포함하여야 한다.',
        links: [{ label: '품질목표관리', path: '/quality-objectives' }]
      },
      {
      {
        id: '5.4.2', label: '품질경영시스템 기획 — 완전성 유지하며 변경 관리',
        detail: '최고 경영자는 품질경영시스템 기획이 이 기준 요구사항 및 품질목표를 충족하도록 수행됨을, 그리고 품질경영시스템 변경 시에도 완전성이 유지됨을 보장하여야 한다.',
        links: [{ label: '품질계획', path: '/quality-plan' }]
      },
      {
        id: '5.5.1', label: '책임·권한 정의 및 내부 의사소통 — 조직도·직무기술서',
        detail: '최고 경영자는 책임 및 권한이 정의되고 문서화되며 조직 내에서 의사소통됨을 보장하여야 한다. 상호 관계를 문서화하여야 하며, 책임 및 권한이 품질에 영향을 미치는 인원에게 명확히 부여되어야 한다.',
        links: [{ label: '조직책임관리', path: '/org-responsibility' }]
      },
      ...
      {
        id: '5.6.3', label: '경영검토 출력사항 — 시스템·제품 개선, 자원 필요사항 결정',
        detail: '경영검토 출력사항에는 품질경영시스템과 그 프로세스의 개선 결정, 고객 요구사항과 관련된 제품의 개선 결정, 자원 필요사항이 포함되어야 하며 기록을 유지하여야 한다.',
        links: [{ label: '경영검토', path: '/management-review' }]
      },
    ]
  },
  {
    ...
    items: [
      {
        id: '6.1', label: '자원 제공 — 품질경영시스템 실행·유지·개선에 필요한 자원',
        detail: '조직은 품질경영시스템을 실행·유지하고 효과성을 유지하며, 법적 요구사항 및 고객 요구사항을 충족하는 데 필요한 자원을 결정하고 제공하여야 한다.',
        links: []
      },
      {
      ...
      {
        id: '6.4', label: '작업환경 — 오염방지·청정도 요구사항 문서화',
        detail: '조직은 제품 요구사항 적합성 달성에 필요한 작업환경 요구사항을 문서화하여야 한다. 멸균 또는 무균 의료기기 제조를 위한 환경 오염 방지 특별 요건을 문서화하고, 해당 인원의 건강·청결·복장 요구사항을 수립하여야 한다.',
        links: [{ label: '작업환경관리', path: '/work-environment' }]
      },
    ]
  },
  {
    ...
    items: [
      ...
      {
        id: '7.2.3', label: '고객의사소통 — 제품정보·조회·불만 처리 방법 수립',
        detail: '조직은 제품 정보, 조회·계약·주문 처리(변경 포함), 고객 피드백(불만 포함)에 관한 의사소통을 위한 절차를 실행하여야 한다.',
        links: [{ label: '고객불만', path: '/complaint' }, { label: '고객요구사항', path: '/customer-req' }]
      },
      {
      ...
      {
        id: '7.3.4', label: '설계·개발 출력 — 입력 충족, 합격기준 참조, 필수특성 명시',
        detail: '설계·개발 출력은 검증 가능한 형태로 제공되어야 하며, 설계·개발 입력 요구사항 충족, 구매·생산·서비스에 적절한 정보 제공, 합격판정기준 포함 또는 참조, 안전한 사용을 위한 필수 특성 규정이 포함되어야 한다.',
        links: [{ label: '설계이력파일', path: '/dhf' }]
      },
      {
      {
        id: '7.3.5', label: '설계·개발 검토 — 단계별 체계적 검토 실시 및 기록',
        detail: '설계·개발의 적절한 단계에서, 검토 대상 단계와 관련된 기능 대표자를 포함한 체계적 검토를 수행하여야 하며, 검토 결과 및 필요한 조치에 대한 기록을 유지하여야 한다.',
        links: [{ label: '설계이력파일', path: '/dhf' }]
      },
      ...
      {
        id: '7.3.8', label: '설계·개발 이관 — 제조 전 양산 능력 검증 및 기록',
        detail: '조직은 설계·개발 출력이 최종 양산 규격으로 이관되기 전에 제조 능력이 제품 요구사항을 충족할 수 있음을 검증하는 절차를 문서화하여야 하며, 이관 결과 및 결론에 대한 기록을 유지하여야 한다.',
        links: [{ label: '설계이력파일', path: '/dhf' }]
      },
      {
      ...
      {
        id: '7.4.2', label: '구매정보 — 제품 설명·승인 요구사항 전달 전 적절성 보장',
        detail: '구매정보는 제품 설명, 제품·절차·프로세스·장비의 승인 요구사항, 인원 자격 요구사항, 품질경영시스템 요구사항을 포함하여야 하며, 공급자에게 전달 전 명시된 구매 요구사항의 적절성을 보장하여야 한다.',
      ...
      {
        id: '7.5.2', label: '청결 및 오염관리 — 청결 요구사항 또는 세척 절차 문서화',
        detail: '조직은 제품 청결 요구사항 또는 오염 방지 필요 시 청결 처리 절차를 문서화하여야 한다. 세척 또는 소독이 필요한 경우 해당 지침을 문서화하여야 하며, 재처리 가능 의료기기에 대한 세척 절차를 포함하여야 한다.',
        links: [{ label: '제품청결·오염관리', path: '/product-cleanliness' }]
      },
      {
      {
        id: '7.5.3', label: '설치활동 — 설치 요구사항 문서화 및 검증 기록',
        detail: '조직은 의료기기 설치 및 설치 검증을 위한 요구사항을 문서화하여야 한다. 고객에 의한 설치인 경우 설치 및 검증을 위한 지침을 제공하여야 하며, 검증 결과에 대한 기록을 유지하여야 한다.',
        links: [{ label: '설치·서비스활동', path: '/installation-service' }]
      },
      {
        id: '7.5.4', label: '서비스활동 — 서비스 절차 문서화 및 기록 유지',
        detail: '서비스 활동이 요구사항으로 규정된 경우, 조직은 서비스 활동 수행 및 요구사항 충족 검증 절차를 문서화하고, 서비스 수행 기록을 유지하여야 한다.',
        links: [{ label: '설치·서비스활동', path: '/installation-service' }]
      },
      ...
      {
        id: '7.5.7', label: '멸균 의료기기 — 멸균 방법·매개변수 기록 유지',
        detail: '멸균 의료기기에 대해 사용된 각 배치(batch)의 멸균 방법 및 멸균 매개변수에 대한 기록을 유지하여야 하며, 멸균 배치 기록은 추적이 가능하도록 유지하여야 한다.',
        links: [{ label: '멸균의료기기관리', path: '/sterile-device' }]
      },
      {
      ...
      {
        id: '7.5.8', label: '제품식별 및 상태 표시 — 생산 전 과정 식별 유지',
        detail: '조직은 제품을 생산·검사·시험의 전 과정에서 적절한 수단으로 식별하고, 모니터링·측정 요구사항과 관련하여 제품 상태를 식별하여야 하며, 출하·납품·서비스 전 과정에서 이 식별을 유지하여야 한다.',
        links: [{ label: '제품식별·상태관리', path: '/product-identification' }]
      },
      {
      ...
      {
        id: '7.6', label: '모니터링·측정 기기 관리 — 교정 절차 및 기록 유지',
        detail: '모니터링·측정 기기의 교정 또는 검증 절차를 문서화하고, 교정 상태를 식별하며, 기기 보호 조치를 실행하여야 한다. 교정 기록(기준, 결과, 기기 식별, 교정일, 다음 교정일, 교정 결과)을 유지하여야 한다.',
        links: [{ label: '교정관리', path: '/calibration' }]
      },
    ]
  },
  {
    ...
    items: [
      ...
      {
        id: '8.2.3', label: '규제당국 보고 — 법적 요구사항에 따른 이상사례 보고 절차',
        detail: '조직은 적용되는 법적 요구사항에서 요구하는 규제당국 보고 절차를 문서화하여야 한다. 이상사례·FSCA(현장 안전성 시정 조치)·부적합 제품 보고에 관한 법적 요구사항에 따른 통지 절차를 포함하여야 한다.',
        links: [{ label: '시판후안전관리', path: '/post-market-safety' }]
      },
      {
      ...
      {
        id: '8.5.1', label: '개선 — 품질경영시스템 지속적 개선 계획·실행',
        detail: '조직은 품질방침, 품질목표, 감사 결과, 데이터 분석, 시정조치, 예방조치, 경영검토를 활용하여 품질경영시스템의 지속적 개선에 필요한 변경사항을 파악하고 실행하여야 한다.',
        links: [{ label: 'CAPA·개선관리', path: '/improvement' }]
      },
      {
    ...
    <AppLayout>
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-xl text-xs text-blue-800">
          ...
          <p><span className="inline-block w-4 h-4 rounded-full bg-green-500 mr-1 align-middle"></span><strong>적합:</strong> 모든 항목 A — 또는 4.1~6.3(4.2.3 제외), 8.2.4 항목에서 B가 있으나 직전 심사 동일항목 B/C 없는 경우</p>
          <p><span className="inline-block w-4 h-4 rounded-full bg-yellow-500 mr-1 align-middle"></span><strong>보완:</strong> 일부 항목 B (C 없음)</p>
          <p><span className="inline-block w-4 h-4 rounded-full bg-red-500 mr-1 align-middle"></span><strong>부적합:</strong> C 항목 있는 경우</p>
        </div>
      </div>
    </AppLayout>
  )
